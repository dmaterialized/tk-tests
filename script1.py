...
def km_to_miles():
    ...
    miles=e1.value.get()*1.606 # didn't need to add float here, why not?
...
e1_value=StringVar() # this is to hold the string and use get methods on it
e1 = Entry(window,textvariable=e1_value) # --> textvariable=e1_value
# create new button, specify window, don't specify label as it's text area.
